...
describe("Schnorr test", function () {
    ...
    it("Check addition in circom", async () => {
        const cir = await wasm_tester(path.join(__dirname, circuitPath, "check_add.circom"));
...
it("Check bits to number conversion in circom", async () => {
        const cir = await wasm_tester(path.join(__dirname, circuitPath, "check_bit2num.circom"));
...
it("Check signature hash in circom", async () => {
        const cir = await wasm_tester(path.join(__dirname, circuitPath, "check_sigHash.circom"));
...
it("Check signature in circom", async () => {
        const cir = await wasm_tester(path.join(__dirname, circuitPath, "check_schnorr.circom"));
